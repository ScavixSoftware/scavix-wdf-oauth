...
Dependencies
------------
* [scavix/wdf-core (^1.1.4)](https://packagist.org/packages/scavix/wdf-core#v1.1.4)
* [league/oauth2-client (^2.9.0)](https://packagist.org/packages/league/oauth2-client#v2.9.0)
